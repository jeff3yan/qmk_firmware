...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------------------------------------+
   * | Ctrl |  Alt  |  Cmd  |              Space                | SRC  | MUT |  L  |  D  |  R  |
   * `-----------------------------------------------------------------------------------------'
   */
  ...
  LAYOUT_directional(
      ...
      KC_LSFT,         KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_SLSH, KC_UP, MO(1),
      KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_SPC, KC_SPC, SRC, MUTE, KC_LEFT, KC_DOWN, KC_RIGHT
      ),
  ...
  LAYOUT_directional(
      ...
      ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, KC_F12, ______,
      ______, ______, ______, ______, ______, ______, ______, ______, ______, KC_F11, ______
      ),
};
